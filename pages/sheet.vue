    ...
    <v-card>
      <v-container fluid>
        <v-container fluid>
          ...
          <v-row justify="center">
            <v-col cols="auto">
              <v-btn-toggle>
                ...
                <v-text-field dense outlined readonly
                              :value="useNepaliCalendar ? selectedNepaliYear : selectedEnglishYear"></v-text-field>
            ...
            <v-col cols="auto">
              <v-btn-toggle>
                ...
                <v-text-field dense outlined readonly
                              :value="useNepaliCalendar ? nepaliMonthList[selectedNepaliMonth-1] : englishMonthList[selectedEnglishMonth-1]"></v-text-field>
          ...
          <v-row>
            <v-col cols="auto">
              <v-btn @click="useNepaliCalendar = !useNepaliCalendar;getSalarySheet()" color="primary" dark>
                <v-icon left>fas fa-calendar-days</v-icon>
                <template v-if="useNepaliCalendar">View English Calendar</template>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {text: "Employer's SSF Contribution", value: "employerSSFcontribution"},
        {text: "Employee's SSF Contribution", value: "employeeSSFcontribution"},
        ...
        {text: "Salary after deductions", value: "totalSalaryAfterDeductions"},
    ...
    getSalarySheet() {
      ...
      this.makePostRequest({
        ...
        data: {
          ...
          month: temp.useNepaliCalendar ? temp.selectedNepaliMonth : temp.selectedEnglishMonth,
          year: temp.useNepaliCalendar ? temp.selectedNepaliYear : temp.selectedEnglishYear,
        }
      }).then((response) => {
